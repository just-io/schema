...
describe('ArraySchema', () => {
    describe('method validate', () => {
        ...
        test('should return error result when value has not right type and has errors', () => {
            const errorKeeper = new ErrorKeeper({ default: defaultErrorFormatters });
            assert.ok(
                !new ArraySchema(new NumberSchema()).validate(null, 'default', errorKeeper, false)
                    .ok,
            );
        ...
        describe('with max items', () => {
            test('should return value result when value has right type', () => {
                ...
                assert.ok(
                    new ArraySchema(new NumberSchema())
                        .maxItems(3)
                        .validate([1, 2, 3], 'default', errorKeeper, false).ok,
                );
            });
            ...
            test('should return error result when value has not right type and has errors', () => {
                ...
                assert.ok(
                    !new ArraySchema(new NumberSchema())
                        .maxItems(3)
                        .validate([1, 2, 3, 4], 'default', errorKeeper, false).ok,
                );
                assert.deepStrictEqual(errorKeeper.makeStringErrors(), [
        ...
        describe('with min items', () => {
            ...
            test('should return error result when value has not right type and has errors', () => {
                ...
                assert.ok(
                    !new ArraySchema(new NumberSchema())
                        .minItems(3)
                        .validate([1, 2], 'default', errorKeeper, false).ok,
                );
                assert.deepStrictEqual(errorKeeper.makeStringErrors(), [
        ...
        describe('with unique', () => {
            ...
            test('should return error result when value has not right type and has errors', () => {
                ...
                assert.ok(
                    !new ArraySchema(new NumberSchema())
                        .unique()
                        .validate([1, 2, 3, 1], 'default', errorKeeper, false).ok,
                );
                assert.deepStrictEqual(errorKeeper.makeStringErrors(), [
    ...
    describe('method cast', () => {
        ...
        test('should return error result when value has not right type and has errors', () => {
            const errorKeeper = new ErrorKeeper({ default: defaultErrorFormatters });
            assert.ok(
                !new ArraySchema(new NumberSchema()).cast(undefined, 'default', errorKeeper, false)
                    .ok,
            );
            assert.deepStrictEqual(errorKeeper.makeStringErrors(), [
                { pointer: [], details: 'Should be "array" type.' },
        ...
        describe('with max items', () => {
            test('should return value result when value has right type', () => {
                ...
                assert.ok(
                    new ArraySchema(new NumberSchema())
                        .maxItems(3)
                        .cast(['1', '2', '3'], 'default', errorKeeper, false).ok,
                );
            });
            ...
            test('should return error result when value has not right type and has errors', () => {
                ...
                assert.ok(
                    !new ArraySchema(new NumberSchema())
                        .maxItems(3)
                        .cast(['1', '2', '3', '4'], 'default', errorKeeper, false).ok,
                );
                assert.deepStrictEqual(errorKeeper.makeStringErrors(), [
                    { pointer: [], details: 'Should contain less than or equal 3 items.' },
                ]);
        ...
        describe('with min items', () => {
            ...
            test('should return error result when value has not right type and has errors', () => {
                ...
                assert.ok(
                    !new ArraySchema(new NumberSchema())
                        .minItems(3)
                        .cast(['1', '2'], 'default', errorKeeper, false).ok,
                );
                assert.deepStrictEqual(errorKeeper.makeStringErrors(), [
                    { pointer: [], details: 'Should contain more than or equal 3 items.' },
                ]);
        ...
        describe('with unique', () => {
            ...
            test('should return error result when value has not right type and has errors', () => {
                ...
                assert.ok(
                    !new ArraySchema(new NumberSchema())
                        .unique()
                        .cast(['1', '2', '3', '1'], 'default', errorKeeper, false).ok,
                );
                assert.deepStrictEqual(errorKeeper.makeStringErrors(), [
                    { pointer: [], details: 'All items should be unique.' },
                ]);
